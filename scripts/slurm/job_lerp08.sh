...
apptainer exec --nv \
  ...
  bash -c "
    ...
    python /workspace/RLinf/examples/embodiment/train_embodied_agent_amp.py \
      ...
      runner.logger.experiment_name=isaaclab_ppo_openpi_pi05_amp_lerp08 \
      ...
      amp.task_reward_lerp=0.8 \
      env.eval.video_cfg.video_base_dir=/workspace/RLinf/results/video/isaaclab_ppo_openpi_pi05_amp_lerp08 \
